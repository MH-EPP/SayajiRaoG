...
var PDFViewerApplication = {
  ...
  switchSidebarView: function pdfViewSwitchSidebarView(view, openSidebar) {
    ...
    var bookmarkView = document.getElementById('bookmarkView');
    var annotationView = document.getElementById('annotationView');
    var thumbsButton = document.getElementById('viewThumbnail');
    var outlineButton = document.getElementById('viewOutline');
    var bookmarkButton = document.getElementById('showBookmark');
    var annotationButton = document.getElementById('showAnnotation');
  ...
  //  var attachmentsButton = document.getElementById('viewAttachments');
    ...
    switch (view) {
      ...
      case 'thumbs':
        ...
        bookmarkButton.classList.remove('toggled');
      ...
      case 'attachments':
       ...
       /* if (attachmentsButton.disabled) {
        ...
        outlineButton.classList.remove('toggled');
        annotationButton.classList.remove('toggled');
        bookmarkButton.classList.add('toggled');
       /* attachmentsButton.classList.add('toggled'); */
        thumbsView.classList.add('hidden');
        outlineView.classList.add('hidden');
       /* attachmentsView.classList.remove('hidden');*/
...
function webViewerInitialized() {
 ...
 /* document.getElementById('viewAttachments').addEventListener('click',
   ...
   document.getElementById('showBookmark').addEventListener('click',
    function() {
      PDFViewerApplication.switchSidebarView('bookmark');
    });

    document.getElementById('showAnnotation').addEventListener('click',
    function() {
      PDFViewerApplication.switchSidebarView('annotation');
    });
...
document.addEventListener('pagerendered', function (e) {
    ...
    renderAnnotationsHighlights(pageIndex);
