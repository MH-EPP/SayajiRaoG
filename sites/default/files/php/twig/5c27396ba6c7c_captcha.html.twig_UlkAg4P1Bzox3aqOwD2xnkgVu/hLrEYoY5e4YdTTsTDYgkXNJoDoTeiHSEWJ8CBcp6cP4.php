...
";
    ...
    {
        return new Twig_Source("{% if details %}
  {{ details }}
{% else %}
    <div class=\"captcha\">{{ element }}</div>
{% endif %}", "modules/contrib/captcha/templates/captcha.html.twig", "/var/www/html/SayajiRao/modules/contrib/captcha/templates/captcha.html.twig");
    }
}
